...
$stmt1 = $pdo ->prepare('SELECT count(book_id) as totalBooks FROM book_details');

//excuting the querry
$stmt1->execute();

                //assigning to the results of variable
                $result = $stmt1->fetch(PDO::FETCH_ASSOC);
              
                // assigning to the book count 
                $bookCount = $result['totalBooks'] + 1;

                //assigning the book id 
                $book_id = $book_code . $bookCount;

                //inserting to the book details 
